...
<div class="row">
    <form class="col s12 m12 l12 offset-l2 " action="adduserform.jsp">
      <div class="row">
        
        <div class="input-field col s12 m4 l2 ">
          <i class="material-icons prefix ">account_circle</i>
          <input id="nom" name="nom" type="text" required="true" class="validate">
          <label class="active"for="nom" data-error="El nombre es requerido" >Nombre</label>
        </div>
        <div class="input-field col s12 m4 l2 ">
          <i class="material-icons prefix">account_circle</i>
          <input id="Apater" name="Apater" type="text" required="true" class="validate">
          <label for="Apater" data-error="El apellido paterno es requerido" >Apellido Paterno</label>
        </div>
        
        <div class="input-field col s12 m4 l2">
          <i class="material-icons prefix">account_circle</i>
          <input id="Amater" name="Amater" type="text" required="true" class="validate">
     ...
     <br>
      ...
      <div class="row">
        <div class="input-field col s12 m4 l2">
          ...
          <input id="email" name="email" type="email" required="true" class="validate">
      ...
      <div class="row">
        <div class="input-field col s12 m4 l2">
          ...
          <input id="edad" name="edad" type="number" required="true" min="18" max="70" class="validate">
      ...
      <div class="row">
        <div class="input-field col s12 m4 l2">
          ...
          <input id="ingresos" name="ingresos" type="number" required="true" min="3000" max="200000" class="validate">
